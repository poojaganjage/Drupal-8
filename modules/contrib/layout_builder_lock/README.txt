...
INSTALLATION
======================
Install/Enable the layout_builder_lock module as you would normally install a contributed Drupal module. Visit
...
We are a Digital Agency, Drupal integrator and Open Digital Experience Platform (DXP) in a single company.
* EPS & KAAS (https://www.drupal.org/eps-kaas)
eps & kaas is a small digital agency that focusses on branding, (Drupal) websites and apps (Android and iPhone).