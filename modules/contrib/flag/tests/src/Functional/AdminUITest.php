...
class AdminUITest extends FlagTestBase {
  ...
  public function doFlagAdd() {
    ...
    $this->assertText($this->t('Messages'));
    $this->assertText($this->t('Flag access'));
    $this->assertText($this->t('Display options'));
    ...
    $this->assertText($this->t('Flag @this_label has been added.', ['@this_label' => $this->label]));
