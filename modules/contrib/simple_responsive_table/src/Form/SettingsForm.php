...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['max_width'] = [
      ...
      '#description' => $this->t('Make table responsive till the screen of size in pixel.'),
      '#default_value' => $config->get('max_width'),
    ];

    $form['enable_admin_page'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable for admin pages'),
      '#description' => $this->t('Make table responsive for admin pages.'),
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    if (!is_numeric($form_state->getValue('max_width'))) {
      $form_state->setErrorByName('max_width', $this->t('Max width should be number.'));
    }
  }
