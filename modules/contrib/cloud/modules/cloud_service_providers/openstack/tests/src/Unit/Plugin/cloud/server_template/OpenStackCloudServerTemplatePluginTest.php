...
namespace Drupal\Tests\openstack\Unit\Plugin\cloud\server_template;
...
use Drupal\openstack\Plugin\cloud\server_template\OpenStackServerTemplatePlugin;
 ...
 * @group Cloud
 */
class OpenStackCloudServerTemplatePluginTest extends UnitTestCase {
  ...
  protected function setUp() {
    ...
    $this->plugin = new OpenStackServerTemplatePlugin(
      [], '', [],
      $this->ec2ServiceMock,
  ...
  public function testLaunch(): void {
    ...
    $openstack_tags = $this->convertToOpenStackTags($mock_tags);
    ...
    foreach ($field_security_groups_test_cases ?: [] as $field_security_groups_test_case) {
      ...
      $template_value_map = [
        ...
        ['field_openstack_image_id', (object) ['value' => $mock_image->getImageId()]],
  ...
  /**
   * Convert mock tag objects to OpenStack tags.
   *
   ...
   *   OpenStack tags.
   */
  private function convertToOpenStackTags(array $mock_tags) {
    $tags = [];
