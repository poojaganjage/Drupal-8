 ...
 *
 * @see \Drupal\openstack\Plugin\Derivative\OpenStackLocalTasks
 */
class OpenStackLocalTasks extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($entities ?: [] as $entity) {
      ...
      $this->derivatives[$id]['route_name'] = 'view.openstack_instance.list';
