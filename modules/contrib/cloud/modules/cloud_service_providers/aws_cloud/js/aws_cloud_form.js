(function ($) {
  ...
  let field_subnet_default_values = drupalSettings.aws_cloud.field_subnet_default_values;
  ...
  let field_security_group_default_values = drupalSettings.aws_cloud.field_security_group_default_values;
  ...
  let field_ssh_key_options = $('select[name=field_ssh_key] option');
