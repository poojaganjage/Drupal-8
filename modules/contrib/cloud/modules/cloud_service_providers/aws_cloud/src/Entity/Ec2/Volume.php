 ...
 *       "delete-multiple-confirm" = "Drupal\aws_cloud\Form\Ec2\VolumeDeleteMultipleForm",
 *     },
 ...
 *     "delete-multiple-form" = "/clouds/aws_cloud/{cloud_context}/volume/delete_multiple",
 *   },
...
class Volume extends CloudContentEntityBase implements VolumeInterface {
  ...
  public function isVolumeUnused() {
    ...
    $unused_interval = time() - ($config->get('aws_cloud_unused_volume_criteria') / (24 * 60 * 60));
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Volume entity.'))
      ->setReadOnly(TRUE);

    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Volume entity.'))
      ->setReadOnly(TRUE);
    ...
    $fields['snapshot_name'] = BaseFieldDefinition::create('string')
      ...
      ->setDescription(t('The Name of the snapshot that was used to create the volume, if applicable. A snapshot is a copy of an @label at a point in time.', ['@label' => $entity_type->getLabel()]))
      ->setDisplayOptions('view', [
        'label' => 'inline',
        'type' => 'string',
        'weight' => -5,
    ...
    $fields['size'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('Size (GB)'))
      ->setDescription(t('The capacity of the @label in GiB. Note that 1 GiB = 1024^3 bytes, whereas 1 GB = 1000^3 bytes.', ['@label' => $entity_type->getLabel()]))
      ->setDisplayOptions('view', [
        'label' => 'inline',
        'type' => 'string',
        'weight' => -5,
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ->setLabel(t('Created'))
      ->setDescription(t('Date/time the @label was created.', ['@label' => $entity_type->getLabel()]))
      ->setDisplayOptions('view', [
        'label' => 'inline',
        'type' => 'timestamp',
        'weight' => -5,
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of the Volume entity author.'))
