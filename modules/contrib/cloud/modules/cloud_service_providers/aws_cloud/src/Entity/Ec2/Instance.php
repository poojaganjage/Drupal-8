 ...
 *       "monitor"                 = "Drupal\aws_cloud\Form\Ec2\InstanceMonitorForm",
 *       "console_output"          = "Drupal\aws_cloud\Form\Ec2\InstanceConsoleOutputForm",
 *       "delete-multiple-confirm" = "Drupal\aws_cloud\Form\Ec2\InstanceDeleteMultipleForm",
 *     },
 ...
 *     "monitor-form"              = "/clouds/aws_cloud/{cloud_context}/instance/{aws_cloud_instance}/monitor",
 *     "console-output-form"       = "/clouds/aws_cloud/{cloud_context}/instance/{aws_cloud_instance}/console_output",
 *     "delete-multiple-form"      = "/clouds/aws_cloud/{cloud_context}/instance/delete_multiple",
 *   },
...
class Instance extends CloudContentEntityBase implements InstanceInterface {
  ...
  public function setBlockDevices($block_devices) {
    return $this->set('block_devices', $block_devices);
  }
  ...
  public function setUserData($user_data) {
    return $this->set('user_data', $user_data);
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_data'] = BaseFieldDefinition::create('string_long')
