...
namespace Drupal\terraform\Plugin\cloud\config;
 ...
 */
class TerraformCloudConfigPlugin extends CloudPluginBase implements CloudConfigPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function loadCredentials($cloud_context) {
    ...
    $credentials = [];
    if ($entity !== FALSE) {
      $credentials['api_token'] = $entity->get('field_api_token')->value;
      $credentials['organization'] = $entity->get('field_organization')->value;
    }
    return $credentials;
  }
  ...
  public function getInstanceCollectionTemplateName() {
    return 'view.terraform_workspace.list';
  }
