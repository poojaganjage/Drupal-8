...
/**
 * Access controller for the persistent volume entity.
 *
 * @see \Drupal\k8s\Entity\K8sPersistentVolume.
 */
class K8sPersistentVolumeAccessControlHandler extends EntityAccessControlHandler {
