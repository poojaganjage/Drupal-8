...
/**
 * Builds the form to delete cloud project type entities.
 */
class CloudProjectTypeDeleteForm extends CloudContentDeleteForm {
  ...
  /**
   * Constructs a new CloudProjectTypeDeleteForm.
   *
  ...
  public function getCancelUrl() {
    return new Url('entity.cloud_project_type.collection');
  }
