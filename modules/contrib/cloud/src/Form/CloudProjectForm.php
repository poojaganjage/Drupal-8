...
class CloudProjectForm extends CloudContentForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $cloud_context = '') {
    /* @var $entity \Drupal\cloud\Entity\CloudProject */
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.cloud_project.canonical', ['cloud_project' => $entity->id(), 'cloud_context' => $entity->getCloudContext()]);
