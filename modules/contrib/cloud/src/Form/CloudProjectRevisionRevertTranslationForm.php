 ...
 */
class CloudProjectRevisionRevertTranslationForm extends CloudProjectRevisionRevertForm {
  ...
  /**
   * Constructs a new CloudProjectRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'cloud_Project_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $cloud_Project_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $cloud_Project_revision);
  ...
  protected function prepareRevertedRevision(CloudProjectInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\cloud\Entity\CloudProjectInterface $default_revision */
    $latest_revision = $this->CloudProjectStorage->load($revision->id());
