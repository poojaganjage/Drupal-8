...
/**
 * Provides cloud context bundles and cloud projects.
 */
class CloudProjectCloudContextBundleDeriver extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    // Loop through all cloud_config bundles and build cloud project
    // links.
    // @TODO: not all implementing clouds will have projects
    // @TODO: Add support for identifying which clouds have projects
    ...
    foreach ($bundles as $key => $bundle) {
      ...
      foreach ($entities as $entity) {
        ...
        if ($entity->bundle() === $base_plugin_definition['cloud_config_bundle']) {
