...
/**
 * @file
 * Contains \Drupal\permissionmodule\PermissionDynamic.
 */

namespace Drupal\permissionmodule;
...
class PermissionDynamic implements ContainerInjectionInterface {
  ...
  /**
   * Constructs a PermissionDynamic instance.
   *
